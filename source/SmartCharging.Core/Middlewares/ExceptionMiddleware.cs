...
namespace SmartCharging.Core.Middlewares;
...
public class ExceptionMiddleware
{
    ...
    private const string ErrorTemplate =
        $"ERROR: HTTP {"{" + nameof(LogModel.RequestMethod) + "}"} / {"{" + nameof(LogModel.RequestPathAndQuery) + "}"} responded as {"{" + nameof(LogModel.ResponseStatusCode) + "}"}";

    private const string BadRequestTemplate =
        $"BAD REQUEST: HTTP {"{" + nameof(LogModel.RequestMethod) + "}"} / {"{" + nameof(LogModel.RequestPathAndQuery) + "}"} responded as {"{" + nameof(LogModel.ResponseStatusCode) + "}"}";
    ...
    private static async Task InternalServerError(HttpContext context, Exception exception, string data,
...
{
    public LogModel(string requestHost, string requestProtocol, string requestMethod, string requestPath,
        string requestPathAndQuery, int responseStatusCode)
    {
